        ...
        <div class="row g-6 mb-6">
            ...
            <div class="col-xxl-4">
                <div class="card h-100">
                    ...
                    <img src="{{ asset('asset_materialize/img/illustrations/trophy.png') }}"
                        class="position-absolute bottom-0 end-0 me-4" height="140" alt="view sales" />
                </div>
            </div>
            <!--/ Congratulations card -->
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                    id="organicSessionsDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1"
                                            type="button" id="projectTimeline" data-bs-toggle="dropdown"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-6">
                            <div class="d-flex align-items-center gap-4">
                                <h4 class="mb-0">62%</h4>
                                <p class="mb-0">Your sales performance is 35% 😎 better compared to
                                    last month</p>
                            </div>
            ...
            <div class="col-xxl-4 col-md-6">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                id="socialNetworkList" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="ri-more-2-line ri-20px"></i>
                            </button>
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('asset_materialize/img/icons/brands/facebook-rounded.png') }}"
                                        alt="facebook" class="me-3" height="34" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 badge bg-label-success rounded-pill">+12%
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('asset_materialize/img/icons/brands/dribbble-rounded.png') }}"
                                        alt="dribbble" class="me-3" height="34" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 badge bg-label-success rounded-pill">+32%
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('asset_materialize/img/icons/brands/twitter-rounded.png') }}"
                                        alt="facebook" class="me-3" height="34" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 badge bg-label-danger rounded-pill">-18%
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('asset_materialize/img/icons/brands/instagram-rounded.png') }}"
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 badge bg-label-success rounded-pill">+42%
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="card h-100">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                    id="monthlyBudgetDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <i class="ri-more-2-line ri-20px"></i>
                                </button>
            ...
            <div class="col-xxl-4 col-md-6">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                id="meetingSchedule" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="ri-more-2-line ri-20px"></i>
                            </button>
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-4">
                                    <img src="{{ asset('asset_materialize/img/avatars/4.png') }}" alt="avatar"
                                        class="rounded-3" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-4">
                                    <img src="{{ asset('asset_materialize/img/avatars/5.png') }}" alt="avatar"
                                        class="rounded-3" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-4">
                                    <img src="{{ asset('asset_materialize/img/avatars/3.png') }}" alt="avatar"
                                        class="rounded-3" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-4">
                                    <img src="{{ asset('asset_materialize/img/avatars/14.png') }}" alt="avatar"
                                        class="rounded-3" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center mb-6">
                                <div class="avatar flex-shrink-0 me-4">
                                    <img src="{{ asset('asset_materialize/img/avatars/8.png') }}" alt="avatar"
                                        class="rounded-3" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex align-items-center">
                                <div class="avatar flex-shrink-0 me-4">
                                    <img src="{{ asset('asset_materialize/img/avatars/1.png') }}" alt="avatar"
                                        class="rounded-3" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                ...
                <div class="card h-100">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                    id="externalLinksDropdown" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <i class="ri-more-2-line ri-20px"></i>
                                </button>
            ...
            <div class="col-xxl-4 col-md-6">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-text-secondary rounded-pill text-muted border-0 p-1" type="button"
                                id="paymentHistory" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="ri-more-2-line ri-20px"></i>
                            </button>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-borderless">
                            <thead>
                                <tr>
                                    <th class="bg-transparent border-bottom py-4 fs-xsmall fw-normal">
                                        Card</th>
                                    <th class="text-center bg-transparent border-bottom py-4 fs-xsmall fw-normal">
                                        Date</th>
                                    <th class="text-end bg-transparent border-bottom py-4 fs-xsmall fw-normal">
                                        Spend</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="d-flex align-items-center py-2">
                                        <div class="px-2 rounded-3 bg-light-gray d-flex align-items-center h-px-30">
                                            <img src="{{ asset('asset_materialize//img/icons/payments/logo-visa.png') }}"
                                ...
                                <tr>
                                    <td class="d-flex align-items-center py-2">
                                        <div class="px-2 rounded-3 bg-light-gray d-flex align-items-center h-px-30">
                                            <img src="{{ asset('asset_materialize//img/icons/payments/logo-mastercard.png') }}"
                                ...
                                <tr>
                                    <td class="d-flex align-items-center py-2">
                                        <div class="px-2 rounded-3 bg-light-gray d-flex align-items-center h-px-30">
                                            <img src="{{ asset('asset_materialize//img/icons/payments/logo-american-express.png') }}"
