...
@section('content')
    ...
    <header class="band-hero"
        style="background-image: url('{{ $label->logo_url ? asset($label->logo_url) : 'https://images.unsplash.com/photo-1611426959571-9941542ea4a8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}');">
        <div class="container">
