...
@section('content')
    ...
    <header class="band-hero"
        style="background-image: url('{{ $release->cover_url ? asset($release->cover_url) : 'https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?q=80&w=2000&auto=format&fit=crop' }}');">
        <div class="container">
